...
$(function() {
    $('#checkout-button').click(function() {
        ...
        if (items.length <= 0) {
            alert("Please select atleast 1 Table first.")
            return false;
        }
        var selected = [];
        ...
        alert("Table reserved successful & reservation will expire after 2 hours from now.")
        location.reload()
    })
    $('#reset-btn').click(function() {
        if (confirm("are you sure to reset the reservation of the table?") === true) {
